...
Axe (Alt) and Lance (Alt) Minor Edits by JaidynReiman.

Bow Weapon Animation by JaidynReiman.

Long Hair + Lykon Variants by JaidynReiman. (Lykon is unfinished.)

Original Bow based on SALVAGED Cavalier Bow Variant by Epicer.

DATonDemand for providing tips on how to improve the animation!